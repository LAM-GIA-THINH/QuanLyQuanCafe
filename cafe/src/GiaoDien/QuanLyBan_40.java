 ...
 * @author THINH
 */
public class QuanLyBan_40 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAddTable.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\cafe\\src\\GiaoDien\\Icon\\Plus_50px.png")); // NOI18N
        ...
        btnDeleteTable.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\cafe\\src\\GiaoDien\\Icon\\Trash_50px.png")); // NOI18N
        ...
        btnUpdate.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\cafe\\src\\GiaoDien\\Icon\\Edit File_50px.png")); // NOI18N
    ...
    private void btnAddTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddTableActionPerformed
        ...
        try {
            ...
            int i = stmt.executeUpdate("INSERT INTO tablez(table_name, note, status_t) VALUES ('" + txtTableNumber.getText() + "','" + txtNoteTable.getText() + "',0)");
            if (i > 0) {
    ...
    private void btnDeleteTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteTableActionPerformed
        ...
        if (idSave >= 0) {
            con = DBUtility_49.getConnection();
            try {
                pstmt = con.prepareStatement("Delete from tablez where ID_t=?");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (idSave >= 0) {
            ...
            con = DBUtility_49.getConnection();
            try {
                pstmt = con.prepareStatement("update tablez set table_name=?, note=? where ID_t=?");
            ...
            JOptionPane.showMessageDialog(null, "Selete ID_t to update");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyBan_40.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyBan_40().setVisible(true);
