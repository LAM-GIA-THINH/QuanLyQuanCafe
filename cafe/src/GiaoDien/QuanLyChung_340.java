 ...
 * @author THINH
 */
public class QuanLyChung_340 extends javax.swing.JFrame {

    /**
     * Creates new form QuanLyChung
     */
//    Account account = new Account();
    public QuanLyChung_340() {
        initComponents();
    }
    ...
    private void btnThongKeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThongKeActionPerformed
        ...
        QuanLyThongKe_340 qltk = new QuanLyThongKe_340();
...
//        dispose();
    ...
    private void btnTablesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTablesActionPerformed
        QuanLyBan_340 qlb = new QuanLyBan_340();
        qlb.setVisible(true);
//        dispose();              
    ...
    private void btnDrinksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDrinksActionPerformed
        // TODO add your handling code here:
        QuanLyDoUong_340 qld = new QuanLyDoUong_340();
        qld.setVisible(true);
//        dispose();
    ...
    private void btnOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrderActionPerformed
        // TODO add your handling code here:
        QuanLyThucDon_340 qlo = new QuanLyThucDon_340();
        qlo.setVisible(true);
//        dispose();
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // TODO add your handling code here:
        if (!AccountDAO_341.getInstance().GetAccount().getUsername().equals("admin")) {
            JOptionPane.showMessageDialog(null, "Bạn không có quyền truy cập chức năng này!");
            return;
        }

        ThemTaiKhoan_340 ttk = new ThemTaiKhoan_340();
        ttk.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

        private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
            // TODO add your handling code here:
            MenuDangNhap_340 mdn = new MenuDangNhap_340();
            mdn.setVisible(true);
            dispose();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
        DoiMatKhau_340 dmk = new DoiMatKhau_340();
        dmk.setVisible(true);
//        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyChung_340.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyChung_340().setVisible(true);
            }
        });
    }
