 ...
 * @author THINH
 */
public class ThemTaiKhoan_40 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\cafe\\src\\GiaoDien\\Icon\\admin.png")); // NOI18N
        ...
        btnAdd.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\cafe\\src\\GiaoDien\\Icon\\Plus_50px.png")); // NOI18N
        ...
        btnDelete.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\cafe\\src\\GiaoDien\\Icon\\Trash_50px.png")); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (idSave >= 0) {
            ...
            if (AccountDAO_41.getInstance().Update(idSave, txtName.getText(), txtPass.getText())) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (AccountDAO_41.getInstance().Add(txtName.getText(), txtUsername.getText(), txtPass.getText())) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        if (idSave >= 0) {
            if (AccountDAO_41.getInstance().Delete(idSave)) {
                LoadTable();
                idSave = -1;
                txtName.setText("");
                txtUsername.setText("");
        ...
        private void tblDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDisplayMouseClicked
            ...
            List<Account_22> list = AccountDAO_41.getInstance().listAccount();
...
//                txtUsername.disable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemTaiKhoan_40.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemTaiKhoan_40().setVisible(true);
            }
        });
    }
