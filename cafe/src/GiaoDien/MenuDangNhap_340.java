 ...
 * @author THINH
 */
public class MenuDangNhap_340 extends javax.swing.JFrame {

    /**
     * Creates new form MenuDangNhap
     */
    public MenuDangNhap_340() {
        initComponents();
    }
    ...
    private void AuthenticateAndLogin() {
        ...
        if (!AccountDAO_341.getInstance().Login(txtUsername.getText(), txtPassword.getText())) {
            txtmessage.setText("Sai tên đăng nhập hoặc mật khẩu!!");
            return;
        }
        QuanLyChung_340 qlc = new QuanLyChung_340();
        qlc.setVisible(true);
        dispose();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuDangNhap_340.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuDangNhap_340().setVisible(true);
            }
        });
    }
