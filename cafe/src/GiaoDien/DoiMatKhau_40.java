 ...
 * @author THINH
 */
public class DoiMatKhau_40 extends javax.swing.JFrame {

    /**
     * Creates new form DoiMatKhau
     */
    public DoiMatKhau_40() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!txtPassOld.getText().equals(AccountDAO_41.getInstance().GetAccount().getPassword())) {
        ...
        if (AccountDAO_41.getInstance().DoiMatKhau(AccountDAO_41.getInstance().GetAccount().getId(), txtPassNew.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoiMatKhau_40.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoiMatKhau_40().setVisible(true);
            }
        });
    }
