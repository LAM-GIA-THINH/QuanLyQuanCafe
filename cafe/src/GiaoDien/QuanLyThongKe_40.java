 ...
 * @author THINH
 */
public class QuanLyThongKe_40 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\cafe\\src\\GiaoDien\\Icon\\invoice.png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyThongKe_40.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyThongKe_40().setVisible(true);
            }
        });
    }
    ...
    private void LoadTableThongKe() {
        ...
        try {
            PreparedStatement pstmt = con.prepareStatement("SELECT account.ten, tablez.table_name, invoice.total_price, invoice.invoice_date FROM invoice, tablez,account WHERE invoice.tables_id=tablez.ID_t AND invoice.account_ID=account.ID AND invoice.status_i=1");
            ...
            Logger.getLogger(QuanLyThongKe_40.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
