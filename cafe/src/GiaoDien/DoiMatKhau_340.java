 ...
 * @author THINH
 */
public class DoiMatKhau_340 extends javax.swing.JFrame {

    /**
     * Creates new form DoiMatKhau
     */
    public DoiMatKhau_340() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!txtPassOld.getText().equals(AccountDAO_341.getInstance().GetAccount().getPassword())) {
        ...
        if (AccountDAO_341.getInstance().DoiMatKhau(AccountDAO_341.getInstance().GetAccount().getId(), txtPassNew.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoiMatKhau_340.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoiMatKhau_340().setVisible(true);
            }
        });
    }
